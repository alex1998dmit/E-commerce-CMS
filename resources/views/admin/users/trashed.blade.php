                            ...
                            <table class="table">
                                ...
                                <tbody class="categories_list" id="categories_list">
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td><a href="{{ route('user.delete', ['id' => $user->id]) }}" class="btn btn-xs btn-danger">Удалить</a></td> --}}
                                        {{-- <td><a href="{{ route('user.restore', ['id' => $user->id]) }}" class="btn btn-xs btn-success">Восстановить</a></td> --}}
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
